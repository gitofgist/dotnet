...
using InventoryManagement.Interface.Common;
...
namespace InventoryManagement.Interface.VendorProduct
{
    public class VendorProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(int? vendorId, int? productId)
        {
            ...
            var vendorProduct = new InventoryManagement.Server.VendorProduct.VendorProduct();
        ...
        public async Task<IActionResult> Create(InventoryManagement.Server.VendorProduct.VendorProduct vendorProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, InventoryManagement.Server.VendorProduct.VendorProduct vendorProduct)
        {
