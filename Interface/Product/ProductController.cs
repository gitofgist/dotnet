...
namespace InventoryManagement.Interface.Product
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(InventoryManagement.Server.Product.Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, InventoryManagement.Server.Product.Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
