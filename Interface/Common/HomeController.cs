...
namespace InventoryManagement.Interface.Common
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> CreateInventory(InventoryManagement.Server.Inventory.Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddProductEntry(int inventoryId, InventoryManagement.Server.Product.ProductEntry productEntry)
        {
